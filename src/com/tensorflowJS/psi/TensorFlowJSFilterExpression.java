...
public class TensorFlowJSFilterExpression extends JSExpressionImpl implements JSCallExpression {
    public TensorFlowJSFilterExpression(IElementType elementType) {
        super(elementType);
    }

    public static boolean isFilterNameRef(PsiReference ref, PsiElement parent) {
        return parent instanceof TensorFlowJSFilterExpression && ((TensorFlowJSFilterExpression)parent).getFilterName() == ref;
    }
