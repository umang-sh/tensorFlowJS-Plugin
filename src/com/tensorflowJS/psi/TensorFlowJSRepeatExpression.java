...
public class TensorFlowJSRepeatExpression extends JSExpressionImpl {
    public TensorFlowJSRepeatExpression(IElementType elementType) {
        super(elementType);
    }
    ...
    public void accept(@NotNull PsiElementVisitor visitor) {
        if (visitor instanceof TensorFlowJSElementVisitor) {
            ((TensorFlowJSElementVisitor)visitor).visitTensorFlowJSRepeatExpression(this);
        } else {
